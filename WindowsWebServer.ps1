Configuration WindowsWebServer {
    ...
    Node localhost {
        ...
        xWebsite 'WoodgroveBankWeb'  
        {  
            Ensure          = 'Present'
            Name            = 'Web Portal'
            PhysicalPath    = 'D:\web' 
            ApplicationPool = 'WoodgroveBankWebPool'
        ...
        xWebAppPool 'WoodgroveBankWebPool' {
            Name            = 'WoodgroveBankWebPool'
        }
        ...
        xWebAppPool 'WoodgroveBankApiPool' {
